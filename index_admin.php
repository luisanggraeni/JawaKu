...
<html>
<head>
<title>JawaKu - Mari Belajar Berbahasa Jawa !</title>
	...
	<div class="container">
		 <div class="header-main">
					...
					<div class="header-logo">
						...
						<div class="top-nav">
							...
							<ul>
								...
								<li><a href="aksarajawa.html"  >Aksara Jawa</a></li>
								<li><a href="tembangjawa.html" >Tembang Jawa</a></li>
								<li><a href="kosakata.html" >Kosa Kata</a></li>
			...
			<div class="bann-bottom">
				<h1>Mari Belajar Berbahasa Jawa !</h1>
				<p>---------------------------------------------------------</p>
				<div class="bann-main">
					<div class="col-md-4 bann-grid">
						<a href="aksarajawa.html"><img src="images/i1.png" alt=""></a>
						<h4>Aksara Jawa</h4>
					</div>
					<div class="col-md-4 bann-grid">
							<a href="tembangjawa.html"><img src="images/i2.png" alt=""></a>
						<h4>Tembang Jawa</h4>
					</div>
					<div class="col-md-4 bann-grid">
							<a href="kosakata.html"><img src="images/i3.png" alt=""></a>
						<h4>Kosa Kata</h4>
				</div>
				<div class="clearfix"> </div>
			</div>
...
<div class="copyright">
	<div class="container">
		<div class="copyright-main">
			   <p>© 2017 Jawaku. Aldila | Amalia | Jihan | Luis <a href="http://smktelkom-mlg.sch.id/" target="_blank">  SMK TELKOM MALANG </a></p>
			<div class="clearfix"> </div>
		</div>
	</div>
</div>
